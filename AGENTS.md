...
> Provisioned from `blueprint/roles/variants/codex/executor.md` (the SSOT). Edit intent there,
> then re-provision. Codex reads this file as its role surface; there is no `.codex/agents`
> persona file in this Codex version.
